...
title = tk.Label(window,text="Being There",bd=10,relief=tk.GROOVE,font=("times new roman",40),bg="lavender",fg="black")
...
canvas.pack()
img = PhotoImage(file=r"C:\Users\manth\Downloads\QR_Attendance-main\QR_Attendance\Bl.png")
